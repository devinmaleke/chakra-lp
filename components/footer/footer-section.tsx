...
export default function FooterSection() {
  return (
    <footer id="page-footer" className="scroll-mt-32 bg-[#2C2419] text-white">
      {/* TOP */}
      <div className="mx-auto grid max-w-7xl gap-14 px-6 py-24 lg:grid-cols-2 lg:gap-20">
        ...
        <div className="text-center lg:text-left">
          ...
          <h2 className="heading-font mb-6 text-4xl leading-tight text-[#F5EEE4] md:text-6xl">
            Relax Your Body,
            <span className="block text-[#C9A96E]">Calm Your Mind</span>
          </h2>

          <p className="mx-auto max-w-xl text-[16px] leading-8 text-[#D8CCBE] lg:mx-0">
          ...
          <Button
            ...
            className="mx-auto mt-10 rounded-full border border-[#C9A96E] bg-transparent px-8 py-6 text-[#C9A96E] transition-all hover:bg-[#C9A96E] hover:text-[#2C2419] lg:mx-0"
          >
            Book Treatment
          </Button>
        </div>
        ...
        <div className="grid gap-5">
          {/* LOCATION */}
          <div className="rounded-[28px] border border-[#C9A96E]/10 bg-[#3A2F24] p-6 transition-all duration-300 hover:border-[#C9A96E]/20">
            <div className="mb-4 flex items-center gap-4">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-[#C9A96E]/20 bg-[#2C2419] text-[#C9A96E]">
                <MapPin size={18} />
              </div>

              <h3 className="text-lg text-[#F5EEE4]">Location</h3>
            </div>
            ...
            <a
              ...
              className="group inline-flex items-start gap-2 leading-7 text-[#D8CCBE] transition hover:text-[#C9A96E]"
            >
              <span>
          ...
          <div className="rounded-[28px] border border-[#C9A96E]/10 bg-[#3A2F24] p-6 transition-all duration-300 hover:border-[#C9A96E]/20">
            <div className="mb-4 flex items-center gap-4">
              ...
              <h3 className="text-lg text-[#F5EEE4]">Opening Hours</h3>
            </div>

            <div className="space-y-2 text-[#D8CCBE]">
              <p>Day : 08.30 - 20.30</p>
          ...
          <div className="rounded-[28px] border border-[#C9A96E]/10 bg-[#3A2F24] p-6 transition-all duration-300 hover:border-[#C9A96E]/20">
            <div className="mb-4 flex items-center gap-4">
              ...
              <h3 className="text-lg text-[#F5EEE4]">Contact</h3>
            </div>

            <div className="space-y-4 text-[#D8CCBE]">
              <a
